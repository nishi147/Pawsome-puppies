...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Healthy, vaccinated puppies from trusted breeders. Bring home happiness today." },
      { property: "og:title", content: "Pawsome Puppies — Find Your Perfect Furry Friend" },
      { property: "og:description", content: "Healthy, vaccinated puppies from trusted breeders. Bring home happiness today." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Pawsome Puppies — Find Your Perfect Furry Friend" },
      { name: "twitter:description", content: "Healthy, vaccinated puppies from trusted breeders. Bring home happiness today." },
